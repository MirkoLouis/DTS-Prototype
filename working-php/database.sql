...
DROP TABLE IF EXISTS cache, cache_locks, jobs, job_batches, failed_jobs, departments, users, user_public_key_histories, password_reset_tokens, sessions, purposes, documents, document_logs, prediction_keywords, daily_department_metrics, database_metrics, report_jobs, integrity_checks;
