...
Acoba, A. G. (2024). Judicial court information management system (J-CIMS) for regional trial court in the Philippines. *Isabela State University Linker Journal of Engineering Computing and Technology*.

Agarkar, M., Borle, A., Deshmukh, A., & Bhagat, M. (2012). An enhanced document management system for SME. *Proceedings - 2012 IEEE 8th World Congress on Services, SERVICES 2012*, 336-339.
...
Bajoria, A. V. (2025). Blockchain-enabled audit trails: Revolutionizing RDBMS data integrity and security. *European Modern Studies Journal*, *9*(2), 112-125.
...
Bala, U., & Muhammad, M. M. (2020). Analysis and design of file tracking system. *Journal of Applied Science, Information and Computing*.

Behrens, S. (2009). Shadow systems: The good, the bad and the ugly. *Communications of the ACM*, *52*(2), 124-129.

Berhouma, H. (2020). A generic model for software documentation and its application in embedded systems developed with scrum. *Proceedings of the 9th International Conference on Software and Information Engineering*.
...
Chintami, A. S., & Astriratma, R. (2021). An information system design of web-based student learning outcomes assessment at Pekayon Jaya VI elementary school. *2021 International Conference on Informatics, Multimedia, Cyber and Information System (ICIMCIS)*, 375-380.

Christinna, M., & Saragih, E. (2022). A new learned construction of Indonesian networks (online) at elementary school Sutomo 1 Medan. *International Journal of Educational Research & Social Sciences*.
...
Hermosa, K. R. (2023). Document management system with tracking and monitoring in Manuel S. Enverga University Foundation-Candelaria Inc. *International Journal of Advanced Research in Computer Science*.
...
Izzulhaq, A. P., Fauzi, R., Suakanto, S., Disina, A. K. H., Mahdin, H., & Salihu, I. A. (2022). Development of user management in Ihya digital ecosystem using iterative incremental method. *2022 International Conference Advancement in Data Science, E-learning and Information Systems (ICADEIS)*, 1-6.

Jaquilmo, C. A., & Sarmiento, J. R. (2023). Web-based electronic document tracking management system. *GSJ*, *11*(5).

Keen, P. G., & Scott Morton, M. S. (1978). *Decision support systems: An organizational perspective*. Addison-Wesley.

Khairi, A., Irawan, J., Fibrian, A. H., Sholeh, A. N., Pratama, W. K. T., Efendi, A., Rahman, Z., & Ikbal, M. (2022). PKM pelatihan y pendampingan penggunaan sistem informasi berbasis web pada pelanggaran santri di pondok pesantren nurul jadid probolinggo. *GUYUB: Journal of Community Engagement*.
...
Kim, S., & Kim, D. (2024). Data-tracking in blockchain utilizing hash chain: A study of structured and adaptive process. *Symmetry*, *16*(1), 62.

Kolte, P. R. (2021). FTS: File tracking system for railway board. *International Journal for Research in Applied Science and Engineering Technology*.

Krohn, H. (2019). Programación de buscadores en JavaScript para diccionarios digitales. *Cuadernos de Lingüística Hispánica*.

Kwon, S., Son, W., & Lee, J. (2023). Holographic multi-channel QR code based copyright distribution management system. *2023 IEEE International Conference on Metaverse Computing, Networking and Applications (MetaCom)*, 684-685.

Lee, S., & Paik, J. (2019). An asynchronous-driven node.js based intermediary-free direct deal distribution platform converged with cloud service. *KSII Trans. Internet Inf. Syst.*, *13*, 4212-4226.
...
Muhammad, I. A. (2019). The benefit of google drive for an organization document management system. *SSRN Electronic Journal*.

Multidisiplin, J., Aisyah, N., & Kholidah, N. (2025). Implementasi role model pada praksis pendidikan pesantren di pondok pesantren nurul jadid and pondok pesantren nurul qadim. *Aafiyah: Jurnal Multidisiplin Ilmu*.

Ngan, C. K., Paat, Y. F., & Green, R. (2022). HDSS: A healthcare decision support system on combining domain knowledge and data analytics for predicting potential risk of mental health. *International Journal of Applied Decision Sciences*, *15*(1).
...
Pérez-Colado, I., Pérez-Colado, V. M., Freire, M., Martínez-Ortiz, I., & Fernández-Manjón, B. (2021). e-learning standards in game-based learning? *2021 International Conference on Advanced Learning Technologies (ICALT)*, 81-82.
...
Rellon, S. J., Diolata, A. J., & Sobejana, N. (2020). Web-based document tracking system using barcode technology with SMS notification. *Social Science Research Network*.
...
Rokayah, C., Sholihah, E. F., & Herdian, F. (2022). Overview of students’ academic stress levels on online learning during the covid-19 pandemic. *Indonesian Journal of Global Health Research*.

Rokosu. (2025). The impact of poor records management on local government administration. *Journal of Public Administration and Social Welfare Research*, *10*(6), 103-119.
...
Takahashi, S., Nakazawa, E., & Akabayashi, A. (2022). In whose best interest? Parental hesitancy toward the COVID-19 vaccine for children in Japan: A literature survey study. *COVID*.
...
Thohir, M. A., Untari, E., Sukamti, Ahdhianto, E., & Desstya, A. (2022). Implementation of design learning based web model in pre-service elementary school teachers. *2022 2nd International Conference on Information Technology and Education (ICIT&E)*, 240-246.

*Towards a bespoke document tracking system for Philippine higher educational institutions*. (2019). *International Journal of Recent Technology and Engineering*.
