<div id="documents-table-body">
    {{-- Desktop Table View (visible on medium screens and up, hidden below medium) --}}
    <div class="overflow-x-auto hidden md:block">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No documents match your search.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    {{-- Mobile Card View (visible below medium screens, hidden on medium and up) --}}
    <div class="grid grid-cols-1 md:hidden">
        @forelse($handledLogs as $log)
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-4 space-y-2">
                ...
                <div class="border-t border-gray-200 dark:border-gray-600 pt-2 mt-2 text-sm text-gray-500 dark:text-gray-400 space-y-1">
                    ...
                    <p><strong>Handled:</strong> {{ $log->created_at->format('M d, Y h:i A') }}</p>
                </div>
        ...
        @empty
            <div class="text-center py-4 text-gray-500 dark:text-gray-400">No documents match your search.</div>
        @endforelse
    </div>
</div>
