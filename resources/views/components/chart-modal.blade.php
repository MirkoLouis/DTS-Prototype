...
-->
<div id="chart-modal" style="display:none;" class="fixed inset-0 bg-gray-600/75 dark:bg-gray-900/75 z-50 transition-opacity flex items-center justify-center p-4">
    <div class="relative z-10 p-5 border w-11/12 md:w-3/4 lg:w-2/3 shadow-lg rounded-md bg-white dark:bg-gray-800 max-h-full overflow-y-auto">
